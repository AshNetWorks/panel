...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  h1 { font-size: 19px; color: #1d1d1f; margin-bottom: 10px; font-weight: 600; }
  p  { font-size: 14px; color: #6e6e73; line-height: 1.75; }
  .tip {
    margin-top: 24px;
    background: #f5f5f7;
    border-radius: 10px;
...
<div class="card">
  <div class="icon">🔗</div>
  <h1>此链接需要通过 App 打开</h1>
  <p>该地址是专用配置链接，浏览器无法直接解析其内容。</p>
  <div class="tip">
    请回到您的账户页面，<br>
    使用「<strong>一键导入</strong>」或复制链接后<br>
    在对应 App 内手动添加。
  </div>
</div>
</body>
